# User Interview — Yar Zar Myo Min Portfolio Website

- **Who:** Yar Zar Myo Min — the developer and owner of the portfolio (interviewed by a fellow Software Engineer friend)
- **When:** 2026-07-24
- **How:** Video call — ~20 min

## What they do today (without your project)

Before building this Next.js portfolio, Yar Zar relied on a Flutter Web portfolio hosted on GitHub Pages. It was functional but had limitations: no built-in contact form backend, no proper SEO metadata management, and the Flutter Web bundle was heavier than needed for a portfolio site. He also didn't have a live email delivery or analytics pipeline — just a static site with a link to his email.
...
- **Performance** — the site is lightweight compared to the previous Flutter Web version, loads fast on Vercel's edge network, and scores well on Lighthouse.
